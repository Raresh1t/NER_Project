...
stats_file = "D:\\Labeling\\pythonscripts\\models\\DeBERTa\\training_stats.csv"
...
for lr, batch_size, epochs, weight_decay, dropout_rate, gradient_accumulation_steps, warmup_ratio, lr_scheduler_type in product(param_grid["learning_rate"],
    ...
    print(f"\n**Training with lr={lr}, batch_size={batch_size}, epochs={epochs}, weight_decay={weight_decay}, dropout={dropout_rate}, gradient={gradient_accumulation_steps}, warmup={warmup_ratio}, lr_scheduler={lr_scheduler_type}**")
    current_params = {
        "learning_rate": lr,
