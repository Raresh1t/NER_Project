...
for lr, batch_size, epochs, weight_decay in product(param_grid["learning_rate"],
                                                    param_grid["batch_size"],
                                                    param_grid["epochs"],
                                                    param_grid["weight_decay"]):
    print(f"\n**Training with lr={lr}, batch_size={batch_size}, epochs={epochs}, weight_decay={weight_decay}**")
